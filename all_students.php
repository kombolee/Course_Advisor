                                        ...
                                        <table class="table table-centered table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href='update.php?studentID=<?php echo $row['studentID'];?>&fn=<?php echo $row['firstName'];?>&ln=<?php echo $row['lastName'];?>&dob=<?php echo $row['dob'];?>&pn=<?php echo $row['phoneNo'];?>&gender=<?php echo $row['gender'];?>&address=<?php echo $row['address'];?>&nation=<?php echo $row['nationality'];?>' class="action-icon"> <i
                                                                class="mdi mdi-square-edit-outline"></i></a>
                                                        <a href='delete.php?delete=<?php echo $row['studentID'];?>' class="action-icon"> <i
