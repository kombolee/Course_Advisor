                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <div class="card-box">
                                            ...
                                            <form action="edit.php" method="POST" class="parsley-examples">
                                            ...
                                            <?php echo "$studentID" ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    value="<?php echo "$fn" ?>" class="form-control"
                                                        id="firstName">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    value="<?php echo "$ln" ?>" class="form-control"
                                                        id="lastName">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    value="<?php echo "$pn" ?>"  class="form-control"
                                                        id="phoneNo">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    value="<?php echo "$nation" ?>"      class="form-control"
                                                        id="nationality">
                                                </div>
