                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">List of Buildings</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <table class="table table-centered table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href='update_building.php?roomNo=<?php echo $row['roomNo'];?>&courseCode=<?php echo $row['courseCode'];?>' class="action-icon"> <i
                                                                class="mdi mdi-square-edit-outline"></i></a>
                                                        <a href='delete_building.php?delete=<?php echo $row['roomNo'];?>' class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                    </td>
                                                </tr>
                                                <?php
                                                    }
