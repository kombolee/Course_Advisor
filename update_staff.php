...
$lecturerFirstname = $_GET['lecturerFirstname'];
$lecturerLastname = $_GET['lecturerLastname'];
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <div class="card-box">
                                            ...
                                            <form action="edit_staff.php" method="POST" class="parsley-examples">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    value="<?php echo "$lecturerFirstname" ?>" class="form-control"
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    value="<?php echo "$lecturerLastname" ?>" class="form-control"
                                                        id="lecturerLastname">
                                                 </div>
                                                 <div class="form-group">
                                                    <label for="phoneNo">Phone No<span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="phoneNo" parsley-trigger="change" required
                                                    value="<?php echo "$phoneNo" ?>" class="form-control"
                                                        id="phoneNo">
                                                 </div>
                                                 <div class="form-group">
                                                    <label for="departmentCode">Department Code<span
                                                            class="text-danger">*</span></label>
                                                    <input type="department" name="department" parsley-trigger="change" required
                                                    value="<?php echo "$departmentCode" ?>" class="form-control"
                                                        id="departmentCode">
                                                 </div>
