                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">List of Staff</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                            ...
                            <div class="card">
                                ...
                                ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <?php echo $row["lecturerFirstname"]; ?>
                                                    </td>
                                                    <td>
                                                    <?php echo $row["lecturerLastname"]; ?>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href='update_staff.php?staffNo=<?php echo $row['staffNo'];?>&lecturerFirstname=<?php echo $row['lecturerFirstname'];?>&lecturerLastname=<?php echo $row['lecturerLastname'];?>&phoneNo=<?php echo $row['phoneNo'];?>&department=<?php echo $row['departmentCode'];?>' class="action-icon"> <i
                                                                class="mdi mdi-square-edit-outline"></i></a>
                                                        <a href='delete_staff.php?delete=<?php echo $row['staffNo'];?>' class="action-icon"> <i
                                        ...
                                        <form method="GET" action="register_new_staff.php">
